...
### DellEMC Z9100 Platform Startup script
...
switch_board_eeprom() {
    case $1 in
        ...
        "delete_device")
                      ...
                      ;;
        *)            echo "Z9100_platform: switch_board_eeprom : invalid command !"
                      ;;
    esac
}
...
switch_board_qsfp_lpmode() {
    case $1 in
        ...
        "disable")  value=0x0
                    ;;
        *)          echo "z9100_platform: switch_board_qsfp_lpmode: invalid command $1!"
                    return
                    ;;
    esac
